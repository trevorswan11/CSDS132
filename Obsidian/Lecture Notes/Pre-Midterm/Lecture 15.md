...
Here are three algorithms proposed (or slight variations of the ones that were proposed) by students in the class.

 Proposed algorithm 1:
  1) Create a new String (or StringBuilder or array) that contains only the letters (in upper case) from the input string
